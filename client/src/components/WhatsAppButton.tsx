// Thunder Kustannus — Kelluva WhatsApp-nappi (pelkkä ikoni)
...
export default function WhatsAppButton() {
  ...
  const ariaLabel = lang === "en" ? "Chat with us on WhatsApp" : "Kirjoita meille WhatsAppiin";
  ...
  return (
    ...
    >
      {/* Virallinen WhatsApp-puhelin-ikoni */}
      <svg
